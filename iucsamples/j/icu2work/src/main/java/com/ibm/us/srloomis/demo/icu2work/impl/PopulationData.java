 ...
 *******************************************************************************
 */
package com.ibm.us.srloomis.demo.icu2work.impl;
...
public class PopulationData {
    ...
    public static Set<TerritoryEntry> getTerritoryEntries(Locale loc) {
        return getTerritoryEntries(loc, null);
    }
    public static Set<TerritoryEntry> getTerritoryEntries(Locale loc, Set<TerritoryEntry> entries) {
        if(entries == null) entries = new TreeSet<TerritoryEntry>();
