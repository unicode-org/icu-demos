...
#
.xlf.txt:
	$(JAVA) -cp $(CLASSPATH) $(XLIFFCONV) -d $(OUTDIR) -t $* $*.xlf
...
#
{$(OUTDIR)}.txt.res:
	$(ICUDIR)\bin\genrb  -s $(OUTDIR) --package-name ufortune -d $(OUTDIR) $*.txt
...
ROOT:
	...
	$(JAVA) -cp $(CLASSPATH) $(XLIFFCONV) -s . -d $(OUTDIR) -c ufortune_root -r ufortune_root.xlf
