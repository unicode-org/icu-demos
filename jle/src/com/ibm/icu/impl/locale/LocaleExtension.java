...
public final class LocaleExtension {
    ...
    public static LocaleExtension get(String extstr) throws InvalidLocaleException {
        ...
        LocaleExtension singleton = EXTENSIONPOOL.get(extstr);
        if (singleton == null) {
            ...
            if (singleton == null) {
                singleton = EXTENSIONPOOL.register(locext.toString(), locext);
            }
        }
        return singleton;
    }
    ...
    static LocaleExtension get(TreeMap<String,String> extensions, String privuse) throws InvalidLocaleException {
        ...
        if (singleton == null) {
            ...
            if (singleton._extensions != null) {
                String kwdstr = singleton._extensions.get(LOCALESINGLETON);
                if (kwdstr != null) {
                    singleton._keywords = parseKeywordSubtags(kwdstr, LOCALESEP);
                }
            }
            singleton = EXTENSIONPOOL.register(singleton._canonical, singleton);
        }
    ...
    static String mapToLocaleExtensionString(Map<String,String> map, StringBuilder buf) {
