...
/**
 * Modified 2001/04/27 by aliu to add more robust handling of
...
char **getcgivars() {
    ...
    if (!request_method || /*aliu*/
	!strcmp(request_method, "GET") || !strcmp(request_method, "HEAD") ) {
        /*aliu*/
        char *queryString = getenv("QUERY_STRING");
        cgiinput= strdup(queryString ? queryString : "");
    }
