...
namespace CollPerfTest
{
    unsafe class CollationPerformanceTest : PerformanceTestFramework
    {
        ...
        private CompareInfo wComp;
        private CompareOptions wOptions = CompareOptions.None;
        ...
        [DllImport("C:\\PerformanceTest\\icu\\bin\\icuin45.dll", EntryPoint = "ucol_close_45")]
        public unsafe static extern void ucol_close(
            IntPtr coll
            );
        ...
        // ICU Test Function
        [DllImport("C:\\PerformanceTest\\icu\\bin\\icuin45.dll", EntryPoint = "ucol_getSortKey_45")]
        public unsafe static extern int ucol_getSortKey(
            IntPtr coll,
            char[] source,
            int sourceLength,
            byte[] results,
        ...
        private void TestICU(int lineNum)
        {
            unsafe
            {
                ucol_getSortKey(coll, Lines[lineNum], Lines[lineNum].Length, resultsB, resultsLength);
            }
        }
    }
}
